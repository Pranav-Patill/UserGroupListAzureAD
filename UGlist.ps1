...
$ServicePrincipalList = Get-AzureADServicePrincipal -ObjectId fb7f9e29-e757-4dd4-b2f0-8a22e12c37ec #Give the Object ID of the application you want to get data
...
#Give the Applcation ID of the application in "--id" parameter
